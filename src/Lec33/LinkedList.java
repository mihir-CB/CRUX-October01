...
public class LinkedList<T> {
	...
	public T getAt(int idx) throws Exception { // O(n)
		if (isEmpty()) {
			throw new Exception("Khaali hai");
	...
	public void addLast(T data) { // O(n)
		if (isEmpty()) {
			addFirst(data);
			return;
		}
	...
	public void addAt(int idx, T data) throws Exception { // O(n)
		if (idx < 0 || idx > size()) {
			throw new IndexOutOfBoundsException("Invalid Index");
	...
	public T removeAt(int idx) throws Exception { // O(n)
		if (isEmpty()) {
			throw new Exception("Khaali hai");
		} else if (idx < 0 || idx >= size()) {
			throw new IndexOutOfBoundsException("Invalid Index");
